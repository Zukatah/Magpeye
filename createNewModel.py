...
from keras.layers import Input, Dense, Conv3D, MaxPooling3D, BatchNormalization, Flatten, Dropout, ZeroPadding3D
from globalConstants import TRAINING_EXAMPLE_DEPTH, TRAINING_EXAMPLE_HEIGHT, TRAINING_EXAMPLE_WIDTH

modelPath = "Models/model_10x240x135_4CCM_CM_FHHMFL_Filters_Nr1.keras"
...
BaNo_1a = BatchNormalization()(Conv3D_1a)
...
BaNo_1b = BatchNormalization()(Conv3D_1b)
MaxPool3D_1 = MaxPooling3D(pool_size=(1,3,3), strides=(1,3,3), padding="valid")(BaNo_1b)

ZeroPadding3D_2a = ZeroPadding3D(padding=(0,1,1))(MaxPool3D_1)
Conv3D_2a = Conv3D(12, (2,3,3), strides=(1,1,1), activation="relu", padding="valid")(ZeroPadding3D_2a)
BaNo_2a = BatchNormalization()(Conv3D_2a)
...
BaNo_2b = BatchNormalization()(Conv3D_2b)
ZeroPadding3D_2c = ZeroPadding3D(padding=((0,0),(0,0),(0,1)))(BaNo_2b)
MaxPool3D_2 = MaxPooling3D(pool_size=(1,2,2), strides=(1,2,2), padding="valid")(ZeroPadding3D_2c)

ZeroPadding3D_3a = ZeroPadding3D(padding=(0,1,1))(MaxPool3D_2)
Conv3D_3a = Conv3D(12, (2,3,3), strides=(1,1,1), activation="relu", padding="valid")(ZeroPadding3D_3a)
BaNo_3a = BatchNormalization()(Conv3D_3a)
ZeroPadding3D_3b = ZeroPadding3D(padding=(0,1,1))(BaNo_3a)
Conv3D_3b = Conv3D(12, (2,3,3), strides=(1,1,1), activation="relu", padding="valid")(ZeroPadding3D_3b)
BaNo_3b = BatchNormalization()(Conv3D_3b)
...
BaNo_4a = BatchNormalization()(Conv3D_4a)
...
BaNo_4b = BatchNormalization()(Conv3D_4b)
MaxPool3D_4 = MaxPooling3D(pool_size=(1,2,2), strides=(1,2,2), padding="valid")(BaNo_4b)
...
BaNo_5a = BatchNormalization()(Conv3D_5a)
MaxPool3D_5 = MaxPooling3D(pool_size=(1,2,2), strides=(1,2,2), padding="valid")(BaNo_5a)
